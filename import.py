...
create_file(f"{base_path}/ordenes-compra/index.blade.php", """@extends('layouts.app')
...
print("\n✅ Vista de Órdenes de Compra creada")
print("Ejecuta: python generate_ordenes_compra_views.py")